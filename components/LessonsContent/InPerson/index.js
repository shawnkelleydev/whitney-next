export default function InPerson() {
  return (
    <article>
      <p>
        My flute studio is based in the north Denver Metro area, and I offer
        weekly private lessons to students from the age of 4 through adult
        seniors. I teach using the Suzuki Method, an approach that has been
        validated by many research studies as a very effective way to learn
        music (as well as other life-skills). The Suzuki Method is unique
        because it approaches music learning with the same principles as
        language acquisition. Specifically, it utilizes listening/imitation,
        repetition, delayed reading, creating a nurturing and supportive
        learning environment, building new skills with music already learned,
        and active parent involvement. Just as children learn language from a
